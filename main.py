...
def init_tracking_db():
    ...
    c = conn.cursor()
    c.execute('''CREATE TABLE IF NOT EXISTS email_opens
...
class SmartMailer:
    def __init__(self, smtp_server, smtp_port, username, password):
        ...
        self.tracking_url = "http://your-domain.com/pixel.png"  # Replace with actual domain
    ...
    def send_bulk_mail(self, csv_file, subject_file, body_file, department_code='all'):
        ...
        for entry in email_data:
            ...
            # Send email
            success = self.send_email(entry['email'], personalized_subject, tracked_body)
...
def main():
    ...
    tracking_thread = threading.Thread(target=app.run, kwargs={'host': '0.0.0.0', 'port': 5000})
